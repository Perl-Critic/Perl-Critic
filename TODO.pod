...
=item * Finish configurability of ValuesAndExpressions::ProhibitMagicNumbers.

The C<allowed_literals> option needs to handle ranges and an C<all_integers>
value.

Also, the documentation still needs some work.
