...
PPI doesn't treat labels with whitepace between them and the following colon
as labels.  Remove TODO from
F<t/ControlStructures/ProhibitLabelsWithSpecialBlockNames.run> once the fix is
released.
