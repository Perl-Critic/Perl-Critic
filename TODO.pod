...
Proposed implementation commited 18-Mar-2007 by wyant, about revision 3241.
...
=item * ValuesAndExpressions::RequireConstantVersion (low severity)


=item * ValuesAndExpressions::ProhibitComplexVersion (medium severity)

L<http://rt.cpan.org/Ticket/Display.html?id=20439>

Both the above committed as revision 3247 et seq.
...
=item * Documentation::RequirePODLinksIncludeText

The whole problem with "on the Foo manpage" being fixed by LE<lt>Foo|FooE<gt>.
