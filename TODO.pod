...
=item * Rework P::C::Config and P::C::PolicyFactory

The interaction between Config and PolicyFactory is a mess.  An instance of
the PolicyFactory should probably be an attribute of the Config.  Then it can
call PolicyFactory::create_policy to construct Policies ad-hoc.

An alternative is to make P::C::PolicyFactory into a singleton, but I'm not
