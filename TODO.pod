...
=item * TestingAndDebugging::RequireUseStrict

Treat "use Moose" as equivalent to "use strict" because Moose always turns on
strictness.
...
All the ones we formerly listed here are now done.  Feel free to thumb through
PBP and add more here.
...
=item * Modules::RequireNoMatchVarsWithUseEnglish
