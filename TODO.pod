...
Much better would be to put the information in the POD in a strucutured manner
...
=item * Make colors configurable.


=item * A function that splits up a PPI::Node's decendants based upon package.
