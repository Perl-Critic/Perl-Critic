...
revision 3822, you need the following in addition to B<all> optional
...
In the absence of C<Test::Deep> and C<Test::Memory::Cycle>, the
relevant tests are simply skipped.  In the absence of the other
