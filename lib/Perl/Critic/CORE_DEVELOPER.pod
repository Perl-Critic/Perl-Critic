...
1.5, but as of mid-2009, the 1.4.4 client seems to be adequate. The
...
** You should do development using Module::Build rather than
...
** There is a suite of author tests available using
...
to worry about them until your code is functionally correct. The
authortest suite requires a BUNCH of extra modules. Just run it, see
what breaks, and install what it seems to need. Eventually it will
work.

** The L<Regexp::Parser|Regexp::Parser> module is needed by
authortest, and used if available by some of the policies. This module
was last touched in 2005, and has some problems. Some of these
problems make it rather noisy under Perl 5.10. You will probably want
to download and apply one of the patches attached to RT ticket 42096
(L<http://rt.cpan.org/Public/Bug/Display.html?id=42096>).
...
=head3 lib/Perl/Critic/Utils/Constants.pm
...
=head3 lib/Perl/Critic/Command.pm
...
=head3 lib/Perl/Critic/OptionsProcessor.pm
...
=head3 lib/Perl/Critic/Config.pm
...
=head3 lib/Perl/Critic/ProfilePrototype.pm
